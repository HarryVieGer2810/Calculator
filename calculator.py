...
class Calculator:
    ...
    def delete(self):
        list = self.current_expression
        self.current_expression = list[0:-1]
        self.update_label()

    def create_delete_button(self):
        button = tk.Button(self.buttons_frame, text='DE', bg=OFF_WHITE, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE,
